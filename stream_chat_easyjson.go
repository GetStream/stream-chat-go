...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo31(out *jwriter.Writer, in SearchRequest) {
	...
	}
	{
		...
		if in.Filters == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v74First := true
			for v74Name, v74Value := range in.Filters {
				if v74First {
					v74First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MessageFilters == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v75First := true
			for v75Name, v75Value := range in.MessageFilters {
				if v75First {
					v75First = false
				} else {
					out.RawByte(',')
		...
		case "resources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Resources = append(out.Resources, v76)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "roles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Roles = append(out.Roles, v77)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo35(out *jwriter.Writer, in Policy) {
	...
	}
	{
		...
		if in.Resources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v78, v79 := range in.Resources {
				if v78 > 0 {
					out.RawByte(',')
				}
		...
		case "unset":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Unset = append(out.Unset, v89)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo37(out *jwriter.Writer, in PartialUserUpdate) {
	...
	if len(in.Set) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v90First := true
			for v90Name, v90Value := range in.Set {
				if v90First {
					v90First = false
				} else {
					out.RawByte(',')
		...
		case "attachments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Attachments = append(out.Attachments, v93)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "latest_reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LatestReactions = append(out.LatestReactions, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "own_reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.OwnReactions = append(out.OwnReactions, v95)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "mentioned_users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MentionedUsers = append(out.MentionedUsers, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo39(out *jwriter.Writer, in Message) {
	...
	}
	{
		...
		if in.LatestReactions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v101, v102 := range in.LatestReactions {
				if v101 > 0 {
					out.RawByte(',')
				}
				if v102 == nil {
	...
	}
	{
		...
		if in.OwnReactions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v103, v104 := range in.OwnReactions {
				if v103 > 0 {
					out.RawByte(',')
				}
				if v104 == nil {
	...
	}
	{
		...
		if in.ReactionCounts == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v105First := true
			for v105Name, v105Value := range in.ReactionCounts {
				if v105First {
					v105First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MentionedUsers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v106, v107 := range in.MentionedUsers {
				if v106 > 0 {
					out.RawByte(',')
				}
				if v107 == nil {
	...
	}
	{
		...
		if in.ExtraData == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v108First := true
			for v108Name, v108Value := range in.ExtraData {
				if v108First {
					v108First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if m, ok := v108Value.(easyjson.Marshaler); ok {
					m.MarshalEasyJSON(out)
				} else if m, ok := v108Value.(json.Marshaler); ok {
					out.Raw(m.MarshalJSON())
				} else {
					out.Raw(json.Marshal(v108Value))
				}
			}
			out.RawByte('}')
		}
		...
		case "commands":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Commands = append(out.Commands, v109)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "permissions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Permissions = append(out.Permissions, v110)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo45(out *jwriter.Writer, in ChannelType) {
	...
	_ = first
	{
		...
		if in.Commands == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v111, v112 := range in.Commands {
				if v111 > 0 {
					out.RawByte(',')
				}
				if v112 == nil {
	...
	}
	{
		...
		if in.Permissions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v113, v114 := range in.Permissions {
				if v113 > 0 {
					out.RawByte(',')
				}
				if v114 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "messages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Messages = append(out.Messages, v116)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "read":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v117 *ChannelRead
					if in.IsNull() {
						in.Skip()
						v117 = nil
					} else {
						if v117 == nil {
							v117 = new(ChannelRead)
						}
						(*v117).UnmarshalEasyJSON(in)
					}
					out.Read = append(out.Read, v117)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo49(out *jwriter.Writer, in Channel) {
	...
	}
	{
		...
		if in.Members == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v118, v119 := range in.Members {
				if v118 > 0 {
					out.RawByte(',')
				}
				if v119 == nil {
	...
	}
	{
		...
		if in.Messages == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v120, v121 := range in.Messages {
				if v120 > 0 {
					out.RawByte(',')
				}
				if v121 == nil {
		...
		case "channel_configs":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v124 *ChannelConfig
					if in.IsNull() {
						in.Skip()
						v124 = nil
					} else {
						if v124 == nil {
							v124 = new(ChannelConfig)
						}
						(*v124).UnmarshalEasyJSON(in)
					}
					(out.ConfigNameMap)[key] = v124
					in.WantComma()
				}
				in.Delim('}')
			}
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						for !in.IsDelim(']') {
							...
							v125 = append(v125, v126)
							in.WantComma()
						}
						in.Delim(']')
					}
					(out.Policies)[key] = v125
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo52(out *jwriter.Writer, in AppConfig) {
	...
	}
	{
		...
		if in.ConfigNameMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v127First := true
			for v127Name, v127Value := range in.ConfigNameMap {
				if v127First {
					v127First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Policies == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v128First := true
			for v128Name, v128Value := range in.Policies {
				if v128First {
					v128First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v128Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v129, v130 := range v128Value {
						if v129 > 0 {
							out.RawByte(',')
						}
