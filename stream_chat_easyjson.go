	...
	for !in.IsDelim('}') {
		...
		case "message_filters":
			if in.IsNull() {
				...
				in.Delim('{')
				if !in.IsDelim('}') {
					out.MessageFilters = make(map[string]interface{})
				} else {
					out.MessageFilters = nil
				}
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV231(out *jwriter.Writer, in SearchRequest) {
	...
	}
	{
		...
		if in.Filters == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v75First := true
			for v75Name, v75Value := range in.Filters {
				if v75First {
					v75First = false
				} else {
					out.RawByte(',')
	...
	{
		const prefix string = ",\"message_filters\":"
		out.RawString(prefix)
		if in.MessageFilters == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			out.RawString(`null`)
		} else {
			out.RawByte('{')
			v76First := true
			for v76Name, v76Value := range in.MessageFilters {
				if v76First {
					v76First = false
				} else {
					out.RawByte(',')
		...
		case "resources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Resources = append(out.Resources, v79)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "roles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Roles = append(out.Roles, v80)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV235(out *jwriter.Writer, in Policy) {
	...
	}
	{
		...
		if in.Resources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v81, v82 := range in.Resources {
				if v81 > 0 {
					out.RawByte(',')
				}
		...
		case "resources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Resources = append(out.Resources, v85)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "roles":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Roles = append(out.Roles, v86)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV236(out *jwriter.Writer, in Permission) {
	...
	}
	{
		...
		if in.Resources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v87, v88 := range in.Resources {
				if v87 > 0 {
					out.RawByte(',')
				}
		...
		case "unset":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Unset = append(out.Unset, v92)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV237(out *jwriter.Writer, in PartialUserUpdate) {
	...
	if len(in.Set) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v93First := true
			for v93Name, v93Value := range in.Set {
				if v93First {
					v93First = false
				} else {
					out.RawByte(',')
		...
		case "attachments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Attachments = append(out.Attachments, v96)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "latest_reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.LatestReactions = append(out.LatestReactions, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "own_reactions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.OwnReactions = append(out.OwnReactions, v98)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "mentioned_users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MentionedUsers = append(out.MentionedUsers, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV239(out *jwriter.Writer, in Message) {
	...
	}
	{
		...
		if in.Attachments == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v102, v103 := range in.Attachments {
				if v102 > 0 {
					out.RawByte(',')
				}
				if v103 == nil {
	...
	}
	{
		...
		if in.LatestReactions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v104, v105 := range in.LatestReactions {
				if v104 > 0 {
					out.RawByte(',')
				}
				if v105 == nil {
	...
	}
	{
		...
		if in.OwnReactions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v106, v107 := range in.OwnReactions {
				if v106 > 0 {
					out.RawByte(',')
				}
				if v107 == nil {
	...
	}
	{
		...
		if in.ReactionCounts == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v108First := true
			for v108Name, v108Value := range in.ReactionCounts {
				if v108First {
					v108First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MentionedUsers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v109, v110 := range in.MentionedUsers {
				if v109 > 0 {
					out.RawByte(',')
				}
				if v110 == nil {
	...
	}
	{
		...
		if in.ExtraData == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v111First := true
			for v111Name, v111Value := range in.ExtraData {
				if v111First {
					v111First = false
				} else {
					out.RawByte(',')
		...
		case "commands":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Commands = append(out.Commands, v112)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "permissions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Permissions = append(out.Permissions, v113)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV245(out *jwriter.Writer, in ChannelType) {
	...
	_ = first
	{
		...
		if in.Commands == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v114, v115 := range in.Commands {
				if v114 > 0 {
					out.RawByte(',')
				}
				if v115 == nil {
	...
	}
	{
		...
		if in.Permissions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v116, v117 := range in.Permissions {
				if v116 > 0 {
					out.RawByte(',')
				}
				if v117 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "members":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v118 *ChannelMember
					if in.IsNull() {
						in.Skip()
						v118 = nil
					} else {
						if v118 == nil {
							v118 = new(ChannelMember)
						}
						(*v118).UnmarshalEasyJSON(in)
					}
					out.Members = append(out.Members, v118)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "messages":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Messages = append(out.Messages, v119)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "read":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v120 *ChannelRead
					if in.IsNull() {
						in.Skip()
						v120 = nil
					} else {
						if v120 == nil {
							v120 = new(ChannelRead)
						}
						(*v120).UnmarshalEasyJSON(in)
					}
					out.Read = append(out.Read, v120)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV249(out *jwriter.Writer, in Channel) {
	...
	}
	{
		...
		if in.Members == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v121, v122 := range in.Members {
				if v121 > 0 {
					out.RawByte(',')
				}
				if v122 == nil {
	...
	}
	{
		...
		if in.Messages == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v123, v124 := range in.Messages {
				if v123 > 0 {
					out.RawByte(',')
				}
				if v124 == nil {
		...
		case "channel_configs":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v127 *ChannelConfig
					if in.IsNull() {
						in.Skip()
						v127 = nil
					} else {
						if v127 == nil {
							v127 = new(ChannelConfig)
						}
						(*v127).UnmarshalEasyJSON(in)
					}
					(out.ConfigNameMap)[key] = v127
					in.WantComma()
				}
				in.Delim('}')
			}
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						for !in.IsDelim(']') {
							...
							v128 = append(v128, v129)
							in.WantComma()
						}
						in.Delim(']')
					}
					(out.Policies)[key] = v128
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGoV252(out *jwriter.Writer, in AppConfig) {
	...
	}
	{
		...
		if in.ConfigNameMap == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v130First := true
			for v130Name, v130Value := range in.ConfigNameMap {
				if v130First {
					v130First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.Policies == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v131First := true
			for v131Name, v131Value := range in.Policies {
				if v131First {
					v131First = false
				} else {
					out.RawByte(',')
