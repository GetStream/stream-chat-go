	...
	for !in.IsDelim('}') {
		...
		case "mentioned_users":
			if in.IsNull() {
				...
				if out.MentionedUsers == nil {
					if !in.IsDelim(']') {
						out.MentionedUsers = make([]User, 0, 0)
					} else {
				...
				for !in.IsDelim(']') {
					...
					out.MentionedUsers = append(out.MentionedUsers, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson458e82b7EncodeGithubComGetStreamStreamChatGo19(out *jwriter.Writer, in Message) {
	...
	}
	{
		...
		if in.ExtraData == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
			...
			out.RawByte('{')
			v59First := true
			for v59Name, v59Value := range in.ExtraData {
				if v59First {
					v59First = false
				} else {
					out.RawByte(',')
	...
	}
	{
		...
		if in.MentionedUsers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v60, v61 := range in.MentionedUsers {
				if v60 > 0 {
					out.RawByte(',')
				}
