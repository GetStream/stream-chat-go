...
// options: Pagination params, e.g. GetReactions(msgID, PaginateLimit(50), PaginateOffset(50))
func (ch *Channel) GetReactions(messageID string, options ...Option) ([]*Reaction, error) {
	if messageID == "" {
		return nil, errors.New("message ID is empty")
	}
