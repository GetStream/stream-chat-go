> **Note:** [`getstream-go`](https://github.com/GetStream/getstream-go) is the new full-product SDK for Stream, covering Chat, Video, Moderation, and Feeds with long-term support.
>
