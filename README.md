...
[![godoc](https://pkg.go.dev/badge/GetStream/stream-chat-go)](https://pkg.go.dev/github.com/GetStream/stream-chat-go/v1?tab=doc)
...
```shell
go get github.com/GetStream/stream-chat-go/v1
```
...
import (
	...
	stream "github.com/GetStream/stream-chat-go/v1"
)
