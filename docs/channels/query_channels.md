...
> [!NOTE]
> For supported query operators, see [Query Syntax Operators](/chat/docs/go-golang/query_syntax_operators/).
...
For the full list of supported query operators, see [Query Syntax Operators](/chat/docs/go-golang/query_syntax_operators/).
...
broadFilter := map[string]interface{}{
	"type": "messaging",
}
