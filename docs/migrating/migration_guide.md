...
**Step 3b: Prepare Import File.** The [import section](/chat/docs/go-golang/import/) has the full details. First practice with a small import.
...
**Step 4: Final Import.** Next, [Import](/chat/docs/go-golang/import/) all historical data.
...
2. Export chat data in Stream's [import format](/chat/docs/go-golang/import/)
...
2. Review the [Importing Data](/chat/docs/go-golang/import/) guide
