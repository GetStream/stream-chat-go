...
The five default channel types come with good default permission policies. You can find more information on how to manage permissions in the [Channel Types section](/chat/docs/go-golang/chat_permission_policies/).
...
newChannelType.Name = "my-channel-type"
newChannelType.TypingEvents = true
newChannelType.ReadEvents = true
newChannelType.Reactions = true
newChannelType.Replies = true
client.CreateChannelType(newChannelType)

// Update an existing channel type
client.UpdateChannelType("my-channel-type", map[string]interface{}{
  "reactions":          false,
...
Please note that applications have a hard limit of 50 channel types. If you need more than this please have a look at the [Multi-tenant & Teams](/chat/docs/go-golang/multi_tenant_chat/) section.
