...
The complete list of supported events is identical to those sent through webhooks and can be found on the [Events](/chat/docs/go-golang/webhook_events/) page.
